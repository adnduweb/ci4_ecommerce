...
class AdminBrandController extends AdminController
{
    ...
    public $pathcontroller  = '/ecommerce/catalogue/brand';
    ...
    {
        AssetsBO::add_js([$this->get_current_theme_view('controllers/' . $this->controller . '/js/listBrand.js', 'default')]);
        helper('form');
        ...
        return view($this->get_current_theme_view('brand/index', $this->type), $this->data);
    }
    ...
    public function renderForm($id = null)
    {
        ...
        return view($this->get_current_theme_view('brand/form', 'Adnduweb/Ci4_ecommerce'), $this->data);
    }
