...
class AuthCustomer extends BaseConfig
{
    ...
    //
    public $requireActivation = 'Adnduweb\Ci4_ecommerce\Authentication\Activators\EmailActivator';
    ...
    //
    public $activeResetter = 'Adnduweb\Ci4_ecommerce\Authentication\Resetters\EmailResetter';
    ...
    public $customerActivators = [
        'Adnduweb\Ci4_ecommerce\Authentication\Activators\EmailActivator' => [
            'fromEmail' => null,
            'fromName' => null,
        ],
    ];
    ...
    public $customerResetters = [
        'Adnduweb\Ci4_ecommerce\Authentication\Resetters\EmailResetter' => [
            'fromEmail' => null,
            'fromName' => null,
        ],
    ];
