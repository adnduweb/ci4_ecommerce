 ...
 *
 * @package Adnduweb\Ci4_ecommerce\Authentication\Passwords\Validators
 */
class NothingPersonalValidator extends BaseValidator implements ValidatorInterface
{
     ...
     * comes from Adnduweb\Ci4_ecommerce\Entities\User properties username and email.
     *
     ...
     * the `$personalFields` property in Adnduweb\Ci4_ecommerce\Config\Auth, e.g.
     *
     ...
     * Similarity values equal to, or greater than Adnduweb\Ci4_ecommerce\Config::maxSimilarity
